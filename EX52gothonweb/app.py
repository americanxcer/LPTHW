...
import map
from nose.tools import *    #i hope this imports the lexicon stuff so the userinput
from gothonweb import lexicon # doesn't have to be so exact. or I guess that it learns the parts of sentences?
